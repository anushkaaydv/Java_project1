...
public class usingthread0 extends Thread {
    int seats;
    ...
    public static void main(String[] args) {
        ...
        usingthread0 user1=new usingthread0();//user 1 first after tht it jumps to user 2 without implementing whole body!
        usingthread0 user2= new usingthread0();
        user1.seats=7;
        user1.start();
        user2.seats=6;
        user2.start();
...
}// soln is to use synchronized keyword!
